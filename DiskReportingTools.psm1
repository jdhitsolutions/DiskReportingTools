...
New-Variable -Name DiskReportingModule -Value '0.9.0' -Description 'The DiskReportingTools module version used in verbose messaging.'

Export-ModuleMember -Variable DiskReportingANSI, DiskReportingModule